# FTP Creation Menu
$filename = "Log_FTP-"+ (Get-Date -Format "MM-dd-yyyy_HHmmss")
...
$FTPMenu = New-Object System.Windows.Forms.form
$FTPMenu.Text = "FTP ID Creation"
$FTPMenu.Size = '800,450'
...
$FTPMenu.Controls.Add($NetidLabel)
...
$FTPMenu.Controls.Add($DescriptionLabel)
...
$FTPMenu.Controls.Add($TaskLabel)
...
$FTPMenu.Controls.Add($WorkstationLabel)
...
$FTPMenu.Controls.Add($OwnerLabel)
...
$FTPMenu.Controls.Add($PswdLabel)
...
$FTPMenu.Controls.Add($RandomPswdButton)
...
$FTPMenu.Controls.Add($resetbutton)
$FTPMenu.Controls.Add($validatebutton)
$FTPMenu.Controls.Add($okbutton)
$FTPMenu.Controls.Add($cancelbutton)

$NullLabel = New-Object System.Windows.Forms.Label
$NullLabel.Location = '50,300'
$NullLabel.ForeColor = 'Red'

$FTPMenu.Controls.Add($NullLabel)
...
$FTPMenu.Controls.Add($SendMailButton)
...
#ID CREATION LOGIC
#fixed variable
$OU = "OU=FTP ServiceID,OU=Service Accounts,OU=Administration,OU=APTIV,DC=aptiv,DC=com"
$domain = "aptiv.com"

$FTPMenu.CancelButton = $cancelbutton
    ...
    
    {
        ...
        $Password = ConvertTo-SecureString "$Pass" -AsPlainText -Force
         New-ADUser -SamAccountName $Sam `
          ...
          # Add FTP to groups
            Add-ADGroupMember -Identity "FTP_Production" -Members $Sam
            Add-ADGroupMember -Identity "AUDIT_SPECIAL ID" -Members $Sam
            Add-ADGroupMember -Identity "Avecto_StandardUser" -Members $Sam
            write-information "Added $Sam to FTP_Production, AUDIT_SPECIAL ID & Avecto_StandardUser Groups "
          Sleep 1
