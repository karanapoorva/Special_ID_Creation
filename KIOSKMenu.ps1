# KIOSK Creation Menu
$filename = "Log_KIOSK-"+ (Get-Date -Format "MM-dd-yyyy_HHmmss")
...
$KIOSKMenu = New-Object System.Windows.Forms.form
$KIOSKMenu.Text = "KIOSK ID Creation"
$KIOSKMenu.Size = '800,450'
...
$KIOSKMenu.Controls.Add($NetidLabel)
...
$KIOSKMenu.Controls.Add($DescriptionLabel)
...
$KIOSKMenu.Controls.Add($TaskLabel)
...
$KIOSKMenu.Controls.Add($WorkstationLabel)
...
$KIOSKMenu.Controls.Add($OwnerLabel)
...
$KIOSKMenu.Controls.Add($PswdLabel)
...
$KIOSKMenu.Controls.Add($RandomPswdButton)
...
$KIOSKMenu.Controls.Add($resetbutton)
$KIOSKMenu.Controls.Add($validatebutton)
$KIOSKMenu.Controls.Add($okbutton)
$KIOSKMenu.Controls.Add($cancelbutton)

$NullLabel = New-Object System.Windows.Forms.Label
$NullLabel.Location = '50,300'
$NullLabel.ForeColor = 'Red'

$KIOSKMenu.Controls.Add($NullLabel)
...
$KIOSKMenu.Controls.Add($SendMailButton)
...
#ID CREATION LOGIC
#fixed variable
$OU = "OU=KIOSK ServiceID,OU=Service Accounts,OU=Administration,OU=APTIV,DC=aptiv,DC=com"
$domain = "aptiv.com"

$KIOSKMenu.CancelButton = $cancelbutton
    ...
    
    {
        ...
        $Password = ConvertTo-SecureString "$Pass" -AsPlainText -Force
         New-ADUser -SamAccountName $Sam `
          ...
          # Add KIOSK to groups
            Add-ADGroupMember -Identity "EFS_Restricted_ID's" -Members $Sam
            Add-ADGroupMember -Identity "AUDIT_SPECIAL ID" -Members $Sam
            Add-ADGroupMember -Identity "Avecto_StandardUser" -Members $Sam
            write-information "Added $Sam to EFS_Restricted_ID's, AUDIT_SPECIAL ID & Avecto_StandardUser Groups "
          Sleep 1
